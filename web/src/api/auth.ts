...
import type { CompletePasswordResetInput, LoginInput, RegisterInput } from '@shared/schemas/auth'
...
export const completePasswordReset = (input: CompletePasswordResetInput) =>
  apiPost<AuthResponse>('/auth/complete-password-reset', input)
